...
//---------------------------------------------------------------------------
//Авторазмер с автоудалением заголовка списка
//---------------------------------------------------------------------------
x = thisComp.layer("Theme").sourceRectAtTime();
w = thisComp.layer("text").sourceRectAtTime();
if(x.width > w.width)
{t = x.width}
else
{t = w.width}
h = w.height + x.height; 
// Определяем написано ли что-то в заголовке. U - кол-во добавленных пикселей
if(x.height<1) {u=420}
else {u=490}
[t+200,h+u]
